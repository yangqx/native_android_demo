...
public class DialogActivity extends AppCompatActivity {
    ...
    class OnClick implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ToastUtil.showMsg(DialogActivity.this,"你很诚实！"+view.getId());
            switch (view.getId()){
                case R.id.btn_dialog1:
                    AlertDialog.Builder builder = new AlertDialog.Builder(DialogActivity.this);
                    builder.setTitle("请回答").setMessage("你觉得课程如何？")
                            .setIcon(R.drawable.icon_arrow_off)
                ...
                case R.id.btn_dialog4:
                    ...
                    builder4.setTitle("选择兴趣").setMultiChoiceItems(array4, isSelected, new DialogInterface.OnMultiChoiceClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i, boolean b) {
                            ToastUtil.showMsg(
                                    DialogActivity.this,array4[i]+":"+b
                            );
                        }
                ...
                case R.id.btn_dialog5:
                    ...
                    Button btnLogin = v.findViewById(R.id.et_login);
